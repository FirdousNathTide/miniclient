...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.factory<_i425.MarvelCharactersApi>(
      () => _i425.MarvelCharactersApi.new(gh<_i361.Dio>()),
    );
    gh.factory<_i242.MarvelCharactersRepository>(
      () => _i242.MarvelCharactersRepository(gh<_i425.MarvelCharactersApi>()),
    );
    gh.factory<_i378.MarvelCharactersBloc>(
      () => _i378.MarvelCharactersBloc(
        gh<_i242.MarvelCharactersRepository>(),
        gh<_i804.MarvelCharactersNavigator>(),
      ),
    );
    return this;
  }
